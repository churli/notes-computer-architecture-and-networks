...
FILENAME=computer_architecture_and_networks
KINDLEMOD=-kindle
CALIBREFNAME=~/Calibre\ Library/Tommaso\ Bianucci/Computer\ Architecture\ and\ Networks\ \(20\)/Computer\ Architecture\ and\ Networks\ -\ Tommaso\ Bianucci.pdf
# end vars
